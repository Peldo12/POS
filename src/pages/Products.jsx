...
const Products = () => {
  ...
  return (
    <div className="p-2.5 min-h-dvh relative">
      ...
      {
        products.length === 0 ? <p className="flex justify-center items-center">Nothing to show</p> : 
      ...
      <div className="flex justify-center items-center absolute right-3 bottom-3 text-4xl bg-green-600 rounded-full w-16 h-16 active:scale-95">+</div>
    </div>
  )
}

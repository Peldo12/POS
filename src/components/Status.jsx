...
const Status = ({status = null}) => {
  const bgStatus = status 
    ? "flex items-center gap-1.5 bg-green-50 border border-green-200 rounded-full px-3 py-1.5" 
   : "flex items-center gap-1.5 bg-red-50 border border-red-200 rounded-full px-3 py-1.5"
